  ...
  return (
    <section className="container mx-auto py-16">
      <div className="flex flex-col items-center gap-12 md:flex-row">
        ...
        <div className="relative group h-96 w-full rounded-2xl overflow-hidden md:rounded-xl md:w-1/2  after:inset-0 after:w-full after:h-full after:absolute after:bg-muted/80 after:z-[1]">
